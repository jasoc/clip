...
export class BackendService {
    ...
    private async sendRequest<ReturnType>(method: string, relativeUrl: string, body: any = null, params?: any, callback: (response: HttpResponse<HttpBody<ReturnType>>) => void = () => {}): Promise<HttpResponse<HttpBody<ReturnType>>> {
        ...
        let response = await firstValueFrom(this.httpClient.request<HttpBody<ReturnType>>(method, this.baseUrl + relativeUrl, {
            body,
            params: httpPar,
            observe: 'response',
    ...
    public async get<ReturnType>(relativeUrl: string, params?: any, callback?: (response: HttpResponse<HttpBody<ReturnType>>) => void): Promise<HttpResponse<HttpBody<ReturnType>>> {
        return this.sendRequest('GET', relativeUrl, null, params, callback);
    }

    public async put<ReturnType>(relativeUrl: string, body: any, callback?: (response: HttpResponse<HttpBody<ReturnType>>) => void): Promise<HttpResponse<HttpBody<ReturnType>>> {
        return this.sendRequest('PUT', relativeUrl, body, null, callback);
    }

    public async delete<ReturnType>(relativeUrl: string, callback?: (response: HttpResponse<HttpBody<ReturnType>>) => void): Promise<HttpResponse<HttpBody<ReturnType>>> {
        return this.sendRequest('DELETE', relativeUrl, null, null, callback);
    }

    public async patch<ReturnType>(relativeUrl: string, body: any, callback?: (response: HttpResponse<HttpBody<ReturnType>>) => void): Promise<HttpResponse<HttpBody<ReturnType>>> {
