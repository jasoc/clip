...
from schemas import HttpResponseModel, UserModel
...
@users_router.get("/", response_model=HttpResponseModel[List[UserModel]], status_code=status.HTTP_200_OK, include_in_schema=False)
...
@users_router.get("/{user_id}/", response_model=HttpResponseModel[UserModel], include_in_schema=False)
