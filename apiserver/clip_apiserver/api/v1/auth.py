...
from authentication import get_password_hash, verify_password, create_access_token
...
@auth_router.post('', response_model=HttpResponseModel[TokenModel])
@auth_router.post("/", response_model=HttpResponseModel[TokenModel], include_in_schema=False)
...
@auth_router.post("/register", response_model=HttpResponseModel[UserModel], status_code=status.HTTP_201_CREATED)
@auth_router.post("/register/", response_model=HttpResponseModel[UserModel], status_code=status.HTTP_201_CREATED, include_in_schema=False)
