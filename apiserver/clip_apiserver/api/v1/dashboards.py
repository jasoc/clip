...
@dashboards_router.post("/", response_model=HttpResponseModel[DashboardModel], status_code=status.HTTP_201_CREATED, include_in_schema=False)
...
@dashboards_router.get("/", response_model=HttpResponseModel[List[DashboardModel]], status_code=status.HTTP_200_OK, include_in_schema=False)
...
@dashboards_router.get("/{dashboard_id}/", response_model=HttpResponseModel[DashboardModel], include_in_schema=False)
...
@dashboards_router.put("/{dashboard_id}/", response_model=HttpResponseModel[DashboardModel], include_in_schema=False)
...
@dashboards_router.delete("/{dashboard_id}/", status_code=status.HTTP_204_NO_CONTENT, include_in_schema=False)
